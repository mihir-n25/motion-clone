...
const Navigation = () => {
  ...
  const [isCollapsed, setIsCollapsed] = useState(isMobile); //if less true
  ...
  return (
    <>
      <aside
        ref={sidebarRef}
        className={cn(
          "group/sidebar h-screen w-60 overflow-y-auto bg-secondary flex relative flex-col z-[99999]",
      ...
      >
        ...
        <div
          ...
          onClick={resetWidth}
          className="opacity-0 group-hover/sidebar:opacity-100 transition cursor-ew-resize absolute h-screen w-1 bg-primary/30 right-0 top-0"
        />
      </aside>
      <div
        ref={navbarRef}
